                    ...
                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <i class="fa fa-edit"></i><span class="ml-2">Edit Telegram Name</span>
                            </a></td>
                            </tr>
                            @endforeach
                        </tbody>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Edit Username Telegram - {{$j->dosen}} </h5>
                        </div>
                        <div class="modal-body">
                            <form method="post" action="telegram/update/{{ $j->id }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="telegram" id="telegram" class="form-control" value="{{$j->telegram}}" aria-label="day" aria-describedby="basic-addon1">
                                    @if($errors->has('basic'))
