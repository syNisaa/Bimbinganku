...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="card-body">
                    ...
                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <a data-bs-toggle="modal" data-bs-target="#modalcatatan{{ $s->id }}" class="btn btn-small text-success">
                                Beri Catatan</span></a>
                                </td>
                            </tr>
                            @endforeach
      ...
      <!-- Modal Update -->
      @foreach($skripsi as $s)
            <div class="modal" tabindex="-1" id="modalcatatan{{ $s->id }}">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">BERI CATATAN REVISI</h5>
                        </div>
                        <div class="modal-body">
                            <form method="post" action="catatan/tambah/{{ $s->id }}" enctype="multipart/form-data">

                                @csrf
                                @method('put')

                                <div class="form-group">
                                    <label>Catatan Dosen <small>*Revisi / Masukan</small></label>
                                    <input type="text" name="catatan" id="catatan" class="form-control" placeholder="Catatan Untuk Mahasiswa" aria-label="day" aria-describedby="basic-addon1">
                                    @if($errors->has('basic'))
