  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="card-body">
                    ...
                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><a data-bs-toggle="modal" data-bs-target="#lihatcatatan{{ $s->id }}" class="btn btn-small btn btn-outline-success"> Catatan Dosen</span></a>
                                </a></td>
      ...
      @foreach($skripsi as $s)
        ...
        @foreach($skripsi as $s)
        <div class="modal" tabindex="-1" id="lihatcatatan{{ $s->id }}">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
